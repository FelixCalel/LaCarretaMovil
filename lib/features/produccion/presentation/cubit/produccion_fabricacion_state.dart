...
enum ProduccionFabricacionStatus { initial, loading, loaded, error }

class ProduccionFabricacionState {
  final ProduccionFabricacionStatus status;
  ...
  // Selección múltiple para "Cargar a SAP"
  ...
  const ProduccionFabricacionState({
    this.status = ProduccionFabricacionStatus.initial,
    this.errorMessage,
    this.successMessage,
    this.isSaving = false,
  ...
  bool get isLoading => status == ProduccionFabricacionStatus.loading;
  ...
  ProduccionFabricacionState copyWith({
    ProduccionFabricacionStatus? status,
    String? errorMessage,
    ...
    return ProduccionFabricacionState(
...
extension _ConsolidatedFabricacionProductSum on ConsolidatedProductModel {
