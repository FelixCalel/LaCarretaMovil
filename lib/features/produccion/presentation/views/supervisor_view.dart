...
import '../cubit/produccion_supervisor_state.dart';
import '../../domain/produccion_model.dart';
import '../widgets/consolidado_product_card.dart';
import '../widgets/supervisor_order_detail_modal.dart';
...
class SupervisorView extends StatelessWidget {
  ...
  void _showOrderDetailModal(
    ...
    PedidoAgrupadoModel order,
    ProduccionSupervisorCubit cubit,
  ) {
    showModalBottomSheet(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (ctx) => SupervisorOrderDetailModal(
        order: order,
        onAcceptOrder: (comentario) {
          cubit.aceptarPedido(order, comentario: comentario);
        },
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ProduccionSupervisorCubit, ProduccionSupervisorState>(
      listener: (context, state) {
        if (state.errorMessage != null) {
          ...
          context.read<ProduccionSupervisorCubit>().clearMessages();
        }
      ...
      builder: (context, state) {
          ...
          return const Center(
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12),
                Text(
                  'Cargando pedidos de supervisor...',
        ...
        return RefreshIndicator(
          color: _emeraldColor,
          onRefresh: () =>
              context.read<ProduccionSupervisorCubit>().loadData(silent: false),
          child: Column(
            children: [
              ...
              // Botón inferior flotante "Pasar a Digitador"
  ...
  Widget _buildTopControls(
    BuildContext context,
    ProduccionSupervisorState state,
    bool isDark,
  ) {
    final cubit = context.read<ProduccionSupervisorCubit>();
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'No hay pedidos de supervisor para los filtros seleccionados.',
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return Card(
          ...
          child: InkWell(
            borderRadius: BorderRadius.circular(10),
            onTap: () => _showOrderDetailModal(context, group, cubit),
            child: Padding(
              padding: const EdgeInsets.all(12),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
          ...
          child: ConstrainedBox(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                onPressed: state.isSaving ? null : () => cubit.avanzarADigitador(),
                ...
                child: state.isSaving
                    ...
                    : Text(
                        'Pasar a Digitador (${state.selectedKeys.length})',
                        style: const TextStyle(
                          fontSize: 13,
                          fontWeight: FontWeight.bold,
                        ),
